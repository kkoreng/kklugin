...
abstract class PluginExtension @Inject constructor(objects: ObjectFactory) {
    ...
    @get:Input @get:Optional val loadBefore: ListProperty<String> = objects.listProperty(String::class.java)
    ...
    @get:Input @get:Optional val libraries: ListProperty<String> = objects.listProperty(String::class.java)
    @get:Input @get:Optional val foliaSupported: Property<Boolean> = objects.property(Boolean::class.java)
    @get:Input @get:Optional val paperPluginLoader: Property<String> = objects.property(String::class.java)
    @get:Input @get:Optional val paperSkipLibraries: Property<Boolean> = objects.property(Boolean::class.java)
    ...
    @get:Internal val commands: NamedDomainObjectContainer<CommandSpec> = objects.domainObjectContainer(CommandSpec::class.java)
